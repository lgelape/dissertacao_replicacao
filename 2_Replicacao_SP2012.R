...
url <- "http://agencia.tse.jus.br/estatistica/sead/eleicoes/eleicoes2012/votosecao/vsec_1t_SP.zip"
estado <- getTse(url)
...
lv <- read.csv2("https://raw.githubusercontent.com/lgelape/dissertacao_replicacao/master/Atributos_lv_SP2012.csv", fileEncoding = "Latin1")
...
num_eleitos <- c(10123, 10318, 11333, 13015, 13100, 13110, 13114, 13222, 13633, 13651, 13690, 13696, 13700, 13800, 14000, 14138, 14200, 14444, 15000, 15115, 15622, 15633, 22611, 22678, 22888, 23000, 23321, 25000, 25250, 31031, 40096, 40123, 40401, 43456, 43666, 43678, 43888, 45000, 45157, 45190, 45321, 45444, 45450, 45451, 45555, 45678, 50650, 55000, 55005, 55123, 55255, 55321, 55400, 55800, 65000)
...
write.csv2(base_eleitos, "SP2012_eleitos.csv", row.names = F)
